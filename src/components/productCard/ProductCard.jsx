...
function ProductCard() {
  ...
  const filteredProducts = product
    .filter((obj) => {
      ...
      return (
        obj.title.toLowerCase().includes(searchKeyLower) ||
        obj.category.toLowerCase().includes(searchKeyLower)
      );
    })
  ...
  return (
    <>
      <Filter resetFilters={resetFilters} searchkey={searchkey} setSearchkey={setSearchkey} />
