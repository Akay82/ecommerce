          ...
          <Tabs defaultIndex={0} className="">
            ...
            <TabPanel>
              <div className="px-4 md:px-0 mb-16">
                <h1
                  className="text-center mb-5 text-3xl text-gray-500 font-semibold underline"
                                  ...
                                  <div onClick={() => deleteProduct(item)}>
                                    ...
                                    >
                                      <path
                                        ...
                                        d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.021-2.09 2.201v.916m7.5 0a48.038 48.038 0 00-7.5 0"
                                      />
                                    </svg>
                                  </div>
        ...
        <div className="relative overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                {order.map((allorder, orderIndex) => (
                    <tbody key={`order-${orderIndex}`}>
                        {allorder.cartItems && allorder.cartItems.length > 0 ? (
